...
public class DemoProducer extends ArrowheadClientMain {
	  ...
	  public static void main(String[] args) {
	    ...
	    new DemoProducer(args);
	  }

	  private DemoProducer(String[] args) {
	    //Register the application components the REST library need to know about
	    Set<Class<?>> classes = new HashSet<>(Arrays.asList(OrchestrationPushResource.class, RestResource.class));
